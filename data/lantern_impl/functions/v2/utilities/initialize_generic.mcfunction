...
execute unless block -30000000 0 8880 minecraft:lectern[facing=east]{Book:{tag:{}}} run function lantern_impl:v2/utilities/place_lectern
...
# If the old command block is present, replace it with stone.
execute if block -30000000 0 8883 minecraft:repeating_command_block run setblock -30000000 0 8883 minecraft:stone
